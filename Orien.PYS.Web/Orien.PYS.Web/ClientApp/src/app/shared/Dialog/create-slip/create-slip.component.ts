    ...
    slip.Users.forEach((element:number) => {
      // if(this.getUserDataById(element).azureID != owner.azureID){
        ...
        var emailBody:EmailBody = {
          ...
          Subject: "A Split is Generated by " + owner.name + " of INR " + slip.Amount + " for " + slip.Name,
          Body: "Hi " + splitUser.name + ",\n \n A split made of Amount INR " + slip.Amount + " as '" + slip.Name + "'. \n \n You Own INR " + own + ". \n You Current Balance is INR " + (this.calculatesingledebt(owner.id, splitUser.id) - own) + "\n\n Thanks and Regards \n Pay Your Share"
        }
